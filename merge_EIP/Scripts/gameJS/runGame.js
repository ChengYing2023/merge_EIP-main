...
function Rungame() {
    ...
    const gameStart = {
        ...
        preload: function () {
            ...
            this.load.image('logo', '/Content/images/mengo/ui/title.png');
            this.load.image('startBtn', '/Content/images/mengo/ui/startbtn.png');
    ...
    const gamePlay = {
        ...
        preload: function () {
            ...
            // 遊戲結束後的標題
            this.load.image('gameover', '/Content/images/mengo/ui/gameover.png');
            this.load.image('tryAgainBtn', '/Content/images/mengo/ui/tryagain.png');
            // 腳色動畫
        ...
        create: function () {
            ...
            const hittest = (player, rock) => {
                ...
                clearInterval(timer);
                this.gameover = this.add.image(w / 2, h / 2+30, 'gameover');
                this.gameover.setScale(0.8);
                this.tryAgainBtn = this.add.image(w / 2, h / 2 + 60, 'tryAgainBtn');
